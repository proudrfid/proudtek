...
const EDITORIAL_PRIMARY_ACTION_LABELS: Record<string, string> = {
  ...
  "/products/rfid-tags/uhf-rfid-apparel-hang-tag/": "Request apparel hang tag quote",
  "/products/rfid-tags/uhf-rfid-woven-care-label/": "Request woven RFID label quote",
  ...
  "/products/rfid-cards/rfid-blocking-card/": "Request RFID blocking card quote",
