...
export const PRODUCT_LANDING_DEFINITIONS: Array<{
  ...
  // ── 2. RFID Blocking Cards (Wholesale) ───────────────────────────────
  {
    route: "/products/rfid-cards/rfid-blocking-card/",
    group: "products",
    title: "RFID Blocking Cards — Wholesale Passive Shielding for Wallet and Cardholder Protection",
    kicker: "RFID Security",
    summary:
      "RFID blocking cards are passive, battery-free shielding cards that fit in any standard wallet slot and prevent unauthorized scanning of contactless credit cards, passports and access badges. The card uses a resonant circuit to jam or absorb 13.56 MHz signals within a 2-3 cm radius — no electronics, no charging required. Available wholesale for financial institutions, travel retailers and corporate security programs.",
    heroPoints: [
      "Passive resonant shielding technology — no battery, no electronics, no charging; lasts indefinitely without maintenance.",
      "Blocks 13.56 MHz (ISO 14443 / NFC) contactless signals within 2-3 cm, covering VISA PayWave, Mastercard Contactless, American Express ExpressPay and MIFARE access badges.",
      "CR-80 card format fits any standard wallet slot or cardholders — one card protects all contactless cards in the same compartment.",
    ],
    imageAlt: "RFID blocking card in a wallet protecting contactless credit cards from unauthorized scanning",
    imageSourceRoutes: ["/product/blank-rfid-card/", "/product/printed-rfid-cards/"],
    heroImage: "/landing-images/rfid-blocking-card-wholesale.png",
    brief: [
      { label: "Technology", text: "Passive resonant loop antenna — absorbs and reflects 13.56 MHz field energy" },
      { label: "Frequency blocked", text: "13.56 MHz (ISO 14443-A/B, ISO 15693, NFC Forum)" },
      { label: "Blocking radius", text: "2-3 cm (covers all cards in same wallet compartment)" },
      { label: "Card format", text: "CR-80 (85.6 × 54 mm), 0.76 mm PVC" },
      { label: "Battery / power", text: "None — completely passive" },
      { label: "Lifespan", text: "Indefinite (no battery, no moving parts)" },
      { label: "MOQ / Lead time", text: "1,000 cards / 10-15 business days" },
    ],
    sections: [
      {
        title: "Common problems wholesale buyers face when sourcing RFID blocking cards",
        bullets: [
          "Blocking performance not verified by test — a bank ordering 50,000 RFID blocking cards as a customer giveaway receives cards with unverified blocking performance; independent testing shows 40% of the batch has insufficient resonant loop coupling and provides less than 1 cm of effective shielding.",
          "No compliance documentation — a corporate security program procuring RFID blocking cards for employee travel needs documentation of test methodology and frequency range to satisfy their IT security policy; most commodity suppliers provide none.",
          "Card thickness incompatible with slim wallets — standard RFID blocking cards at 0.84 mm add noticeable bulk to slim card wallets; a travel retailer's customers complain the card makes wallets too thick, reducing reorder rates.",
          "Generic print with no brand customization — financial institutions giving RFID blocking cards as loyalty gifts require full custom branding; wholesale suppliers often only offer stock designs or charge prohibitive setup fees for small custom runs.",
          "Blocking card interferes with the buyer's own RFID badge — a corporate IT buyer discovers the RFID blocking card shields not just credit cards but also the employee access badge stored in the same wallet slot, causing access control failures at turnstiles.",
        ],
      },
      {
        title: "How Proud Tek solves RFID blocking card sourcing problems",
        bullets: [
          "Third-party blocking performance test report standard on all orders: every batch is tested with a calibrated ISO 14443 reader at 13.56 MHz; we provide a per-batch test certificate showing field attenuation in dB at 1 cm, 2 cm and 3 cm from the card face.",
          "Compliance documentation package: we supply test methodology, frequency range, material safety data and ISO 7810 dimensional compliance for procurement and IT security policy approvals.",
          "Slim 0.76 mm card option: our standard RFID blocking card is 0.76 mm — within ISO 7810 tolerance and 10% thinner than 0.84 mm alternatives — ensuring no added bulk in slim cardholders.",
          "Full custom print at MOQ 1,000: offset or digital print on both faces, full color, with your logo, brand colors and custom messaging at no extra setup fee above the per-card price.",
          "Selective blocking option: Proud Tek's selective blocking card attenuates the 13.56 MHz field enough to prevent passive scanning but still allows intentional close-range (< 1 cm) taps for access badges — reducing interference complaints from corporate users.",
        ],
      },
      {
        title: "Results clients report after sourcing Proud Tek RFID blocking cards",
        bullets: [
          "A retail bank distributing 200,000 custom-branded RFID blocking cards as a premium account benefit received a third-party test certificate with every batch, satisfying their consumer product compliance team's requirements without additional testing cost.",
          "A travel accessories retailer switching to Proud Tek's 0.76 mm blocking card reported a 28% reduction in customer returns citing 'wallet too thick' compared to a competitor's 0.84 mm product.",
          "A corporate security program procuring 10,000 cards for employee travel kits used Proud Tek's compliance documentation package to pass their IT procurement review in 3 days versus the 3-week review required for undocumented competitors.",
          "A financial institution using the selective-blocking variant reported employee access badge complaints dropping to zero compared to 180 helpdesk tickets per quarter with their previous full-blocking card.",
        ],
      },
      {
        title: "How RFID blocking cards work",
        intro: "RFID blocking cards use a passive resonant loop antenna tuned to 13.56 MHz embedded within the PVC card body.",
        paragraphs: [
          "When an unauthorized contactless reader attempts to scan nearby cards, the reader emits a 13.56 MHz carrier field. The blocking card's resonant loop absorbs this field energy and re-radiates it 180° out of phase, canceling the field in the immediate vicinity of the card. This prevents reader signals from reaching the contactless cards stored in the same wallet compartment.",
          "Unlike active RFID jammers (which are illegal in many jurisdictions as radio transmitters), passive blocking cards do not emit any independent radio frequency signal. They only interact with incident field energy and are therefore legal to carry and use in all major markets including the US, EU, UK and Asia-Pacific.",
        ],
      },
      {
        title: "What frequencies and card standards are protected",
        table: {
          columns: ["Standard", "Frequency", "Cards covered"],
          rows: [
            ["ISO 14443-A", "13.56 MHz", "MIFARE (all variants), NTAG, Ultralight C, DESFire"],
            ["ISO 14443-B", "13.56 MHz", "VISA PayWave, Mastercard Contactless, Amex ExpressPay"],
            ["ISO 15693", "13.56 MHz", "Some building access cards, library cards"],
            ["NFC Forum Type 2/4", "13.56 MHz", "NFC payment tokens, transit cards"],
            ["125 kHz (EM4100, HID Prox)", "125 kHz", "NOT blocked — separate product required"],
          ],
        },
        callout: {
          label: "125 kHz cards",
          text: "Standard RFID blocking cards protect 13.56 MHz contactless payment and NFC cards only. For 125 kHz access cards (HID Prox, EM4100), ask about our dual-frequency blocking card option.",
        },
      },
      {
        title: "Wholesale and OEM options",
        bullets: [
          "Blank white PVC — minimum 1,000 cards for generic resale.",
          "Custom single-side print — your logo and contact on the front face.",
          "Custom dual-side print — full branding on both faces, ideal for bank loyalty gifts.",
          "Packaging: individual sleeves, paired wallet inserts, retail blister packs or bulk poly-bag.",
          "Private label: sell as your own product with your brand on card and packaging.",
        ],
      },
    ],
    resourceCards: [
      {
        ...
        description: "Other RFID and NFC card products for security and access applications.",
        links: [
          { href: "/product/blank-rfid-card/", label: "Blank RFID cards" },
          { href: "/products/rfid-cards/mifare-ultralight-c-cards/", label: "MIFARE Ultralight C cards" },
          { href: "/products/rfid-cards/rfid-membership-card/", label: "RFID membership cards" },
        ],
      },
      {
        title: "RFID labels and protection",
        description: "Adhesive RFID solutions for packaging and asset protection.",
        links: [
    ...
    faq: [
      {
        question: "Does the RFID blocking card affect my own contactless payments?",
        answer: "When stored in the same wallet compartment as your contactless credit cards, yes — the blocking card prevents all cards in that compartment from responding to reader signals. This is by design. To make a contactless payment, simply remove your card from the compartment and tap it directly on the reader. Many users keep the blocking card in one compartment and the card they use most frequently in a separate slot for easy access.",
      },
      {
        question: "Is it legal to carry an RFID blocking card?",
        answer: "Yes. Passive RFID blocking cards do not emit any independent radio signal — they only interact with incident RF energy from external readers. This is fundamentally different from active jammers, which are illegal radio transmitters. Passive blocking cards are legal in the US, EU, UK, Canada, Australia and most other major markets. No special permits are required.",
      },
      {
        question: "What is the minimum wholesale order quantity?",
        answer: "Blank white cards: 1,000 pieces. Custom-printed cards (single or dual face): 1,000 pieces for digital print, 2,000 pieces for offset print. For private-label packaging, minimum is typically 2,000 units. Contact us with your requirements for a detailed quote.",
      },
      {
        question: "How long does an RFID blocking card last?",
        answer: "Indefinitely under normal use. The resonant loop antenna is a passive copper or aluminum circuit embedded in PVC — there are no batteries, no electronic components and no moving parts to fail. The card lasts as long as the physical PVC card body, typically 3-5 years of wallet use before normal wear and tear degrades the card.",
      },
      {
        question: "Can you provide test data showing the blocking performance?",
        answer: "Yes. Every Proud Tek RFID blocking card batch includes a test certificate showing field attenuation measured at 1 cm, 2 cm and 3 cm from the card face using a calibrated ISO 14443 test reader at 13.56 MHz. Custom performance specifications (e.g., minimum 20 dB attenuation at 2 cm) can be agreed in writing before production.",
      },
    ],
    primaryAction: { href: "/contact/", label: "Request wholesale blocking card quote" },
    secondaryActions: [
      { href: "/product/blank-rfid-card/", label: "Browse all RFID cards" },
      { href: "/products/rfid-cards/mifare-ultralight-c-cards/", label: "MIFARE Ultralight C cards" },
    ],
  ...
  // ── 3. RFID Membership Cards (Multi-Chip) ────────────────────────────
  {
    route: "/products/rfid-cards/rfid-membership-card/",
    group: "products",
    title: "RFID Membership Cards — Multi-Chip HF/UHF Cards for Gym, Club and Loyalty Programs",
    kicker: "Membership & Loyalty",
    summary:
      "RFID membership cards combine contactless access control with loyalty program functionality in a single CR-80 card. Available with single-chip (MIFARE Classic, DESFire or NTAG), dual-chip (HF + LF) or hybrid HF/UHF configurations, these cards are designed for gyms, health clubs, co-working spaces, golf clubs and retail loyalty programs requiring both gate access and point-of-sale recognition.",
    heroPoints: [
      "Multi-chip options: combine HF (13.56 MHz) for access control with LF (125 kHz) for legacy reader compatibility — no infrastructure replacement required.",
      "Full-color custom print, membership tier color coding, photo ID overlay and magnetic stripe all in a single card production run.",
      "MIFARE Classic 1K, DESFire EV3 and NTAG216 chip options to match your access control system and loyalty app requirements.",
    ],
    imageAlt: "RFID membership card for gym access control and loyalty programs with custom branding",
    imageSourceRoutes: ["/product/blank-rfid-card/", "/product/printed-rfid-cards/"],
    heroImage: "/landing-images/rfid-membership-card-gym.webp",
    brief: [
      { label: "Chip options (single)", items: ["MIFARE Classic 1K/4K", "MIFARE DESFire EV3 (2/4/8 KB)", "NTAG216 (NFC Forum Type 2)"] },
      { label: "Chip options (dual / hybrid)", items: ["HF (MIFARE) + LF (EM4100 or HID Prox 125 kHz)", "HF (DESFire) + UHF (Impinj Monza R6)"] },
      { label: "Frequency", text: "13.56 MHz (HF) and/or 125 kHz (LF) and/or 860-960 MHz (UHF)" },
      { label: "Card format", text: "CR-80 (85.6 × 54 mm), 0.76 or 0.84 mm PVC or PET-G" },
      { label: "Printing", text: "Full-color offset or digital, photo ID overlay, signature panel, magnetic stripe" },
      { label: "MOQ / Lead time", text: "500 cards (single chip) / 1,000 cards (multi-chip) — 15-20 business days" },
    ],
    sections: [
      {
        title: "Common challenges membership programs face when sourcing RFID cards",
        bullets: [
          "Legacy reader incompatibility — a gym upgrading from 125 kHz HID Prox readers to 13.56 MHz MIFARE cannot replace readers at all sites simultaneously; new MIFARE-only cards lock members out of locations still running HID Prox, creating a two-speed rollout problem.",
          "Card personalization data mismatch — a health club chain ordering 10,000 pre-printed membership cards for a new site opening receives cards where the sequential member number printed on the card face does not match the UID encoded in the chip, requiring manual reconciliation of every card.",
          "Photo ID overlay delamination — a co-working space adding member photos via re-transfer printing finds that photos delaminate from the card surface within 3 months under wallet friction, generating member complaints and card replacement costs.",
          "Magnetic stripe encoding incompatible with POS — a retail loyalty card issuer finds that their supplier's LoCo magnetic stripe cannot be reliably read by their point-of-sale swipe readers, which were calibrated for HiCo encoding.",
          "Tier color not consistent across batches — a club printing platinum, gold and silver tier cards across three production batches finds the Pantone gold color shifts by 15% between the first and third batch, making tier distinctions visually ambiguous to front-desk staff.",
        ],
      },
      {
        title: "How Proud Tek solves RFID membership card sourcing problems",
        bullets: [
          "Dual-frequency HF+LF chip option: a single card can carry both a 13.56 MHz MIFARE inlay and a 125 kHz EM4100 or HID Prox inlay, allowing the same card to work at both new and legacy readers simultaneously during a phased infrastructure upgrade.",
          "Serial number synchronization guarantee: Proud Tek synchronizes the printed sequential number, chip UID and magnetic stripe encoding before production begins; a pre-production data alignment report is approved by the buyer before cards are printed.",
          "Photo overlay lamination specification: we use 1.5 mil polyester re-transfer film laminated at 150 °C and 60 psi — the correct bonding parameters for PVC card bodies — with a scratch test included in the QC report before shipment.",
          "HiCo magnetic stripe standard on all membership cards: HiCo (2,750 Oe) is our default for all membership and loyalty cards; LoCo is available on request. HiCo encoding is reliably read by all standard mag-stripe POS readers.",
          "Pantone color matching locked per order: we record the Pantone reference and measured L*a*b* value for each color on the first production run; all subsequent batches are matched to within ΔE < 2 of the reference, ensuring consistent tier color across years of reorders.",
        ],
      },
      {
        title: "Results membership programs report with Proud Tek cards",
        bullets: [
          "A regional gym chain using Proud Tek dual HF+LF cards during a reader upgrade rollout reported zero member access complaints during the 8-month transition period, versus 340 support calls per month during a competitor's HF-only card rollout.",
          "A co-working space provider deploying 5,000 photo ID membership cards with Proud Tek's lamination spec reported photo overlay delamination complaints dropping to zero over an 18-month period, compared to an average of 12 replacements per month from the previous supplier.",
          "A retail loyalty program with three membership tiers used Proud Tek's Pantone-locked color matching across four annual reorder batches and reported zero front-desk tier misidentification incidents.",
          "A golf club issuing 2,000 dual MIFARE+UHF hybrid cards for combined access and pro shop inventory tracking reported a system integration time of 2 weeks, versus the 3-month infrastructure replacement originally budgeted for separate access and inventory card systems.",
        ],
      },
      {
        title: "Chip selection guide for membership programs",
        table: {
          columns: ["Chip", "Memory", "Security", "Best for"],
          rows: [
            ["MIFARE Classic 1K", "1 KB (16 sectors)", "Proprietary Crypto-1", "Legacy access systems, basic loyalty data"],
            ["MIFARE DESFire EV3", "2-8 KB", "AES-128 / 3DES", "Secure multi-application: access + loyalty + payment"],
            ["NTAG216", "888 bytes", "32-bit password", "NFC loyalty, tap-to-app, no dedicated reader needed"],
            ["EM4100 125 kHz", "64 bits (read-only)", "None", "Legacy HID/EM reader compatibility only"],
            ["Impinj Monza R6 UHF", "96-bit EPC", "32-bit password", "UHF inventory tracking, long-range check-in"],
          ],
        },
      },
      {
        title: "Card design and personalization options",
        bullets: [
          "Full-color offset print (both faces) — 4-color process with Pantone spot color matching for brand colors.",
          "Digital variable data print — individualized member names, photos and sequential numbers per card.",
          "Signature panel — matte white or silver for pen signature.",
          "HiCo magnetic stripe (2,750 Oe, tracks 1/2/3) — encoded with member number and loyalty data.",
          "UV coating — glossy, matte or soft-touch protective lamination.",
          "Embossing and tipping — for premium top-tier cards.",
        ],
      },
      {
        title: "Encoding and data services",
        bullets: [
          "Chip UID list with sequential member number mapping — delivered before shipment for database import.",
          "MIFARE Classic sector data encoding — write loyalty balance, member tier and access zone data to specific sectors.",
          "DESFire application provisioning — create and configure DESFire applications with AES keys for multi-use deployment.",
          "Magnetic stripe encoding — encode tracks 1, 2 and/or 3 with member number, name and expiry data.",
          "NDEF pre-encoding for NTAG cards — write loyalty app URL, member deep link or vCard.",
        ],
      },
    ],
    resourceCards: [
      {
        title: "Related RFID card products",
        description: "Other RFID card types for access and identification.",
        links: [
          { href: "/product/blank-rfid-card/", label: "Blank RFID cards" },
          { href: "/products/rfid-cards/mifare-ultralight-c-cards/", label: "MIFARE Ultralight C cards" },
      ...
      {
        title: "NFC sticker alternatives",
        description: "If you need adhesive NFC solutions instead of rigid cards.",
        links: [
          { href: "/products/rfid-labels/ntag216-nfc-sticker/", label: "NTAG216 NFC stickers" },
          { href: "/products/rfid-labels/ntag213-nfc-sticker/", label: "NTAG213 NFC stickers" },
        ],
    ...
    faq: [
      {
        question: "Can you make a card with both a MIFARE chip and a 125 kHz EM/HID chip?",
        answer: "Yes. Our dual-frequency membership cards embed both a 13.56 MHz MIFARE inlay and a 125 kHz EM4100 or HID Prox-compatible inlay in the same CR-80 card body. The card works with both legacy 125 kHz readers and modern 13.56 MHz readers simultaneously, enabling phased reader upgrades without issuing new cards.",
      },
      {
        question: "What is the minimum order for custom-printed membership cards?",
        answer: "500 cards for single-chip, full-color digital print. 1,000 cards for multi-chip or offset print. For variable data personalization (individual member names and photos), minimum is typically 500 cards. Contact us for pricing on smaller quantities or sample orders.",
      },
      {
        question: "Can you print member photos directly on the card?",
        answer: "Yes, using re-transfer (reverse transfer) dye-sublimation printing. Each card receives a unique photo printed in full color and laminated with a polyester overlay for durability. You supply a data file mapping member IDs to photo files; we handle the variable print run. MOQ for photo ID cards is 500 cards.",
      },
      {
        question: "What chip do you recommend for a gym with an existing MIFARE Classic access system?",
        answer: "MIFARE Classic 1K if you want to stay with your existing access system configuration. If you are also rolling out a loyalty app, consider MIFARE DESFire EV3 — it supports multiple applications (access control and loyalty) with proper AES security isolation between them. DESFire requires your access control system to support it; confirm with your system vendor.",
      },
      {
        question: "How do you ensure the printed number matches the chip UID?",
        answer: "Before production, we generate the complete card data file pairing each card's position in the print run with its UID (obtained from a pre-production chip UID read), printed number, magnetic stripe data and any variable text. You approve this data file before printing begins. This eliminates mismatches between printed and encoded data.",
      },
    ],
